...
{
    [CustomEditor(typeof(CustomizedList))]
    public class listExampleInspector : Editor
    {
        private ReorderableList reorderableList;

        private CustomizedList listExample
        {
            get
            {
                return target as CustomizedList;
            }
        }

        private void OnEnable()
        {
            reorderableList = new ReorderableList(listExample.list, typeof(ICustomizedList), true, true, true, true);
        ...
        {
            ICustomizedList item = listExample.list[index];
        ...
        {
            listExample.list.Add(new ICustomizedList());
